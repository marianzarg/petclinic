...
public class SimpleObjectRepositoryTest {
    ...
    public static class Create extends SimpleObjectRepositoryTest {
        ...
        public void happyCase() throws Exception {
            ...
            final String someApellido = "TestApellido";
            final String someDNI = "TestDNI";
            final String someSexo = "TestSexo";
            ...
            // when
//            final SimpleObject obj = simpleObjectRepository.create(someName, someApellido, someDNI, someSexo);
